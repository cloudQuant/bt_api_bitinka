...
This package provides **Bitinka exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BITINKA** exchange.
...
| GitHub Repository | https://github.com/cloudQuant/bt_api_bitinka |
| Issue Tracker | https://github.com/cloudQuant/bt_api_bitinka/issues |
...
```
bt_api_bitinka/
├── src/bt_api_bitinka/     # Source code
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_bitinka/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **Bitinka exchange plugin for bt_api**。它提供了与 **BITINKA** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_bitinka |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_bitinka/issues) 反馈问题
